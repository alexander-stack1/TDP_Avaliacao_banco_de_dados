#!/usr/bin/env python3
"""Gera os prints (PNG) do modelo conceitual (notação Chen / brModelo) e do
modelo lógico (relacional, pé-de-galinha) do Case Bolsa de Valores.

Uso:  python3 scripts/gerar_diagramas.py
Saída: docs/01-modelo-conceitual/modelo_conceitual.png
...
def conceitual(saida: Path):
    ...
    fig.text(0.5, 0.965, "Modelo Conceitual — Negociações na Bolsa de Valores (notação Chen / brModelo)",
...
if __name__ == "__main__":
    c = RAIZ / "docs/01-modelo-conceitual/modelo_conceitual.png"
